    ...
    <section className="bg-white py-10">
      <div className="max-w-screen-xl mx-auto px-4 lg:px-8">
        ...
        <div className="bg-gray-50 p-8 rounded-lg shadow-lg mb-12">
          <h2 className="text-3xl font-semibold text-gray-900 mb-6">Dataset</h2>
        ...
        <div className="bg-gray-50 p-8 rounded-lg shadow-lg mb-12">
          ...
          <h3 className="text-2xl font-semibold text-gray-800 mb-4">Image Processing</h3>
          <p className="text-gray-600 mb-4">
          ...
          <h3 className="text-2xl font-semibold text-gray-800 mb-4">Video Processing</h3>
          <p className="text-gray-600 mb-4">
        ...
        <div className="bg-gray-50 p-8 rounded-lg shadow-lg">
          <h2 className="text-3xl font-semibold text-gray-900 mb-6">Limitation</h2>
          <p className="text-gray-600">
            This system can only detect the emotion based on the audio input and may have limitations in recognizing nuanced emotional states or emotions that are not prominently expressed in the audio data.
          </p>
        </div>
      </div>
    </section>
